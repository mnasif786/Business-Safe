var taskEditViewModelLoader = function () {

    function load(triggerButton, tasksOptions) {

        var taskDataViewModel = new TaskRowParameterExtractor(triggerButton, tasksOptions);

        var data = taskDataViewModel.furtherControlMeasureData(); 
        var url = tasksOptions.editFurtherControlMeasureTaskUrl;

        var callback = function (callbackData) {
            new TaskEditViewModel().initialize(callbackData);        
        };
...
function TaskEditViewModel(){
    ...
    var selectors = {
        ...
        dialogNoLongerRequired: "#dialogNoLongerRequired",
        companyId : "#CompanyId",
        ...
        noLongerRequiredButton :"#FurtherActionTaskNoLongerRequiredButton",
        validationSummary: "#FurtherActionTask .validation-summary-errors" 
    };
    ...
    var hookCommandButtons = function(){
        ...
        $(selectors.noLongerRequiredButton).click(function (event) {
            event.preventDefault();
            new TaskNoLongerRequiredViewModel(successfullyAddedFurtherControlMeasureTaskCallBack).initialize();
            return false;
        });
    ...
    var hookEvents = function () {
        $(selectors.isReoccurring).click(function (e) {
