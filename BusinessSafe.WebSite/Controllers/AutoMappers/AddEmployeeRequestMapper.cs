...
{
    public class AddEmployeeRequestMapper : EmployeeRequestMapperBase
    {
        ...
        private NotificationTypeDto MapNotificationType(NotificationTypeViewModel notification)
        {
            switch (notification)
            {
                case NotificationTypeViewModel.Daily: 
                    return NotificationTypeDto.Daily;
                case NotificationTypeViewModel.Weekly:
                    return NotificationTypeDto.Weekly;
                case NotificationTypeViewModel.Monthly:
                    return NotificationTypeDto.Monthly;
                default:
                    return NotificationTypeDto.Daily;
            }
        }
