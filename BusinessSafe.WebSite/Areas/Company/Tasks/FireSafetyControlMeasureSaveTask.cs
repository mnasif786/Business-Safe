...
{
    public class FireSafetyControlMeasureSaveTask : CompanyDefaultsSaveTask
    {
        ...
        public override CompanyDefaultSaveResponse Execute(SaveCompanyDefaultViewModel viewModel, Guid userId)
        {
            ...
            var result =
                CompanyDefaultService.SaveFireSafetyControlMeasure(new SaveCompanyDefaultRequest(request.Id,
                                                                                                 request.Name,
                                                                                                 request.CompanyId,
