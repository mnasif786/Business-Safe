...
{
    public class SourceOfFuelSaveTask : CompanyDefaultsSaveTask
    {
        public SourceOfFuelSaveTask(ICompanyDefaultService companyDefaultService, IDoesCompanyDefaultAlreadyExistGuard companyDefaultAlreadyExistGuard)
        ...
        public override CompanyDefaultSaveResponse Execute(SaveCompanyDefaultViewModel viewModel, Guid userId)
        {
            ...
            var result =
                CompanyDefaultService.SaveSourceOfFuel(new SaveCompanyDefaultRequest(request.Id,
                                                                                                 request.Name,
                                                                                                 request.CompanyId,
