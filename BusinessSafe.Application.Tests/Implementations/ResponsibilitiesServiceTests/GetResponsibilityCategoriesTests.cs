...
namespace BusinessSafe.Application.Tests.Implementations.ResponsibilitiesServiceTests
{
    [TestFixture]
    [Category("Unit")]
    public class GetResponsibilityCategoriesTests
    {
        ...
        public void Setup()
        {
            ...
            _responsibilityCategoryRepository
                .Setup(x => x.GetAll())
                .Returns(new List<ResponsibilityCategory>());
        ...
        [Test]
        public void Given_valid_request_When_GetResponsibilityCategorie_Then_should_call_correct_methods()
        {
            //given
            var target = GetTarget();
            //when
            target.GetResponsibilityCategories();
            //then
            _responsibilityCategoryRepository
                .Verify(x => x.GetAll());
        }
