...
namespace BusinessSafe.Domain.Tests.Entities.PeopleAtRiskTests
{
    ...
    {
        [Test]
        public void Given_all_required_fields_are_available_Then_create_peopleatrisk_method_creates_an_object()
        {
            //Given
            ...
            //When
            var result = PeopleAtRisk.Create( name, companyId, riskAssesmentId, creatingUser);
