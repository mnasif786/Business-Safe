...
namespace BusinessSafe.Domain.Tests.Entities.GeneralRiskAssessmentFurtherActionTasksTests
{
    ...
    public class GetPreviousHistoryTests
    {
        ...
        {
            //Given
            var historytask2 = new MultiHazardRiskAssessmentFurtherControlMeasureTask { TaskAssignedTo = new Employee() { Forename = "Vince", Surname = "Lee" }, TaskReoccurringType = TaskReoccurringType.None, TaskCompletedDate = DateTime.Today.AddDays(-9), TaskCompletionDueDate = DateTime.Today.AddDays(-10) };
            var historytask1 = new MultiHazardRiskAssessmentFurtherControlMeasureTask { TaskAssignedTo = new Employee() { Forename = "Vince", Surname = "Lee" }, TaskReoccurringType = TaskReoccurringType.None, TaskCompletedDate = DateTime.Today, TaskCompletionDueDate = DateTime.Today.AddDays(-1), PrecedingTask = historytask2 };
            var task = new MultiHazardRiskAssessmentFurtherControlMeasureTask { TaskReoccurringType = TaskReoccurringType.None, PrecedingTask = historytask1 };
        ...
        public void Given_a_recurring_task_with_a_preceding_task_completed_When_TaskPreviousHistory_requested_Then_returned_TaskHistoryRecord_has_corresponding_values_set()
        {
            ...
            var mockFcmA = new Mock<MultiHazardRiskAssessmentFurtherControlMeasureTask>();
            ...
            var fcmA = new MultiHazardRiskAssessmentFurtherControlMeasureTask()
                           {
        ...
        private Mock<MultiHazardRiskAssessmentFurtherControlMeasureTask> BuildRecurringFCMTask(Mock<MultiHazardRiskAssessmentFurtherControlMeasureTask> precedingTask)
        {
            var mockNewFcmTask = new Mock<MultiHazardRiskAssessmentFurtherControlMeasureTask>();
