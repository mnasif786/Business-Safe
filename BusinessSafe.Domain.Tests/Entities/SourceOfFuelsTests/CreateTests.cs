...
namespace BusinessSafe.Domain.Tests.Entities.SourceOfFuelsTests
{
    [TestFixture]
    [Category("Unit")]
    public class CreateTests
    {
        ...
        {
            //Given
            const string name = "SourceOfFuelTest";
            const long companyId = 33749;
            const long riskAssesmentId = 33749;
            var creatingUser = new UserForAuditing();

            //When
            var result = SourceOfFuel.Create( name, companyId, riskAssesmentId, creatingUser);
