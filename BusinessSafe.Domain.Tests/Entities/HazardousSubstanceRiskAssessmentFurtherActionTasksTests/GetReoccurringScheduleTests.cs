...
namespace BusinessSafe.Domain.Tests.Entities.HazardousSubstanceRiskAssessmentFurtherActionTasksTests
{
    ...
    public class GetReoccurringScheduleTests
    {
        ...
        {
            //Given
            var task = new HazardousSubstanceRiskAssessmentFurtherControlMeasureTask { TaskReoccurringType = TaskReoccurringType.Weekly, TaskCompletionDueDate = DateTime.Today};
        ...
        {
            //Given
            var task = new HazardousSubstanceRiskAssessmentFurtherControlMeasureTask { TaskReoccurringType = TaskReoccurringType.Monthly, TaskCompletionDueDate = DateTime.Today };
        ...
        {
            //Given
            var task = new HazardousSubstanceRiskAssessmentFurtherControlMeasureTask { TaskReoccurringType = TaskReoccurringType.SixMonthly, TaskCompletionDueDate = DateTime.Today };
