...
namespace BusinessSafe.WebSite.Tests.ViewModelFactory.CompanyDefaultsTaskFactoryTests
{
    [TestFixture]
    [Category("Unit")]
    public class SourceOfFuelSaveTaskTests
    {
        ...
        [Test]
        public void When_executes_Then_should_call_SaveSourceOfFuel_on_service()
        {
            //Given
            ...
            //Then
            _companyDefaultService.Verify(cds => cds.SaveSourceOfFuel(It.IsAny<SaveCompanyDefaultRequest>()), Times.Once());
        }
        ...
        public void When_executes_Then_should_return_correct_result()
        {
            ...
            _companyDefaultService.Setup(x => x.SaveSourceOfFuel(It.IsAny<SaveCompanyDefaultRequest>())).Returns(expectedId);
        ...
        private SourceOfFuelSaveTask CreateSaveTask()
        {
            var saveTask = new SourceOfFuelSaveTask(_companyDefaultService.Object, _doesCompanyDefaultAlreadyExistGuard.Object);
            return saveTask;
        }
    }
}