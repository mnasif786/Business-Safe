...
namespace BusinessSafe.WebSite.Tests.ViewModelFactory.CompanyDefaultsTaskFactoryTests
{
    [TestFixture]
    [Category("Unit")]
    public class SourceOfIgnitionSaveTaskTests
    {
        ...
        [Test]
        public void When_executes_Then_should_call_SaveSourceOfIgnition_on_service()
        {
            //Given
            ...
            //Then
            _companyDefaultService.Verify(cds => cds.SaveSourceOfIgnition(It.IsAny<SaveCompanyDefaultRequest>()), Times.Once());
        }
        ...
        public void When_executes_Then_should_return_correct_result()
        {
            ...
            _companyDefaultService.Setup(x => x.SaveSourceOfIgnition(It.IsAny<SaveCompanyDefaultRequest>())).Returns(expectedId);
        ...
        private SourceOfIgnitionSaveTask CreateSaveTask()
        {
            var saveTask = new SourceOfIgnitionSaveTask(_companyDefaultService.Object, _doesCompanyDefaultAlreadyExistGuard.Object);
            return saveTask;
        }
    }
}