...
namespace BusinessSafe.WebSite.Tests.ViewModelFactory.FurtherControlMeasureTask
{
    [TestFixture]
    [Category("Unit")]
    public class CompleteFurtherControlMeasureTaskViewModelFactoryTests
    {
        ...
        public void Given_valid_parameters_When_GetViewModel_called_Then_correct_view_model_is_returned()
        {
            ...
            Assert.That(viewModel.CompletedComments, Is.EqualTo(_viewFurtherControlMeasureTaskViewModel.TaskCompletedComments));
            Assert.That(viewModel.ViewFurtherControlMeasureTaskViewModel.TaskCompletedBy, Is.EqualTo(_viewFurtherControlMeasureTaskViewModel.TaskCompletedBy));
            Assert.That(viewModel.ViewFurtherControlMeasureTaskViewModel, Is.EqualTo(_viewFurtherControlMeasureTaskViewModel));
        }

        private ICompleteFurtherControlMeasureTaskViewModelFactory GetTarget()
        {
            return new CompleteFurtherControlMeasureTaskViewModelFactory(
