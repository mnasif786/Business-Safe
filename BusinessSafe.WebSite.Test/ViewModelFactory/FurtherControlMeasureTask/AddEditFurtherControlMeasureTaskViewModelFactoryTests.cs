...
namespace BusinessSafe.WebSite.Tests.ViewModelFactory.FurtherControlMeasureTask
{
    ...
    public class AddEditFurtherControlMeasureTaskViewModelFactoryTests
    {
        ...
        private IEditHazardousSubstanceFurtherControlMeasureTaskViewModelFactory GetTarget()
        {
            return new EditHazardousSubstanceFurtherControlMeasureTaskViewModelFactory(
