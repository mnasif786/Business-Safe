...
{
    [TestFixture]
    public class GeneralRiskAssessmentReviewsViewModelFactoryTests
    {
        private GeneralRiskAssessmentReviewsViewModelFactory _target;
        ...
        public void Setup()
        {
            ...
            _target = new GeneralRiskAssessmentReviewsViewModelFactory(_reviewModelFactory.Object);
        }
        ...
        [Test] public void When_GetViewModel_should_return_correct_result()
        {
            // Given
            var viewModel = new RiskAssessmentReviewsViewModel();
            _reviewModelFactory
            ...
            // Then
            Assert.That(result, Is.TypeOf<GeneralRiskAssessmentReviewsViewModel>());
            Assert.That(result.ReviewViewModel, Is.Not.Null);
            Assert.That(result.ReviewViewModel.RiskAssessmentType, Is.EqualTo(RiskAssessmentType.GRA));
