...
namespace BusinessSafe.WebSite.Tests.Controllers.AttachDocument
{
    ...
    public class IndexTests
    {
        ...
        public void SetUp()
        {
            ...
            _riskAssessmentService.Setup(x => x.GetRiskAssessment(_riskAssessmentId, _companyId))
                .Returns(new GeneralRiskAssessmentDto());

            _riskAssessmentService.Setup(x => x.GetPeopleAtRiskDisplayWarningMessages(_riskAssessmentId, _companyId)).
                Returns(_displayMessages);
            ...
            _viewModelFactory
                .Setup(x => x.WithDocumentDisplayMessage(_displayMessages))
                .Returns(_viewModelFactory.Object);

            _viewModelFactory
                .Setup(x => x.WithDocumentDefaultType(DocumentTypeEnum.GRADocumentType))
                .Returns(_viewModelFactory.Object);
        }
        ...
        {
            return new DocumentsController(_viewModelFactory.Object, _riskAssessmentService.Object, null);
        }
    }
}