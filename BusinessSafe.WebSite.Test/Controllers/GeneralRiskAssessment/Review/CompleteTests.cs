...
namespace BusinessSafe.WebSite.Tests.Controllers.GeneralRiskAssessment.Review
{
    [TestFixture]
    [Category("Unit")]
    public class CompleteTests
    {
        ...
        public void SetUp()
        {
            ...
            _viewModelFactory
                    .Setup(x => x.WithRiskAssessmentType(RiskAssessmentType.GRA))
                    .Returns(_viewModelFactory.Object);
        }
        ...
        {
            return new ReviewController(null,_riskAssessmentService.Object,_viewModelFactory.Object);
        }
    }
