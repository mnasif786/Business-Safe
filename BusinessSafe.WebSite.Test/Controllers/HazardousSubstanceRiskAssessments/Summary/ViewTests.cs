...
namespace BusinessSafe.WebSite.Tests.Controllers.HazardousSubstanceRiskAssessments.Summary
{
    ...
    public class ViewTests
    {
        ...
        [Test]
        public void When_View_Then_Returns_View()
        {
            // Given

            // When
            var result = target.View(_riskAssessmentId, It.IsAny<long>());

            // Then
            var isReadOnly = target.ViewBag.IsReadOnly;
            Assert.That(isReadOnly, Is.EqualTo(true));
            Assert.IsInstanceOf<ViewResult>(result);
        }

        [Test]
        public void Given_View_Then_Returns_View_Has_SummaryViewModel()
        {
            // Given

            // When
            var result = target.View(_riskAssessmentId, It.IsAny<long>()) as ViewResult;
        ...
        [Test]
        public void Given_View_Then_Gets_SummaryViewModel_From_Factory()
        {
            // Given

            // When
            target.View(_riskAssessmentId, TestControllerHelpers.CompanyIdAssigned);
