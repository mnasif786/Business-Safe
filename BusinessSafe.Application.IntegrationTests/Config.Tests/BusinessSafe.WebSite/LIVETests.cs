...
namespace BusinessSafe.Application.IntegrationTests.Config.Tests.BusinessSafe.WebSite
{
    ...
    public class LIVETests : BaseConfigTests
    {
        ...
        [TestCase("SQLReportsSuffix", "")]
        [TestCase("FeatureSwitch_Responsibilities", "true")]
        [TestCase("FeatureSwitch_Responsibilities_Wizard", "true")]
        ...
        [TestCase(@"http://pbsdoclibrary:8056/StreamingDocumentLibraryService.svc", "StreamingDocumentLibraryService")]
        [TestCase(@"http://clientdocumentationservice/StreamingClientDocumentService.svc", "StreamingClientDocumentServiceClient")]
        [TestCase(@"http://clientdocumentationservice/ClientDocumentService.svc", "ClientDocumentService")]
        [TestCase(@"http://clientdocumentationservice/DocumentTypeService.svc", "DocumentTypeService")]
        [TestCase(@"http://clientdocumentationservice/DocumentSubTypeService.svc", "DocumentSubTypeService")]
        [TestCase(@"http://pbsreports:80/SQLReports2008/ReportExecution2005.asmx", "ReportExecutionServiceSoap")]
        [TestCase(@"http://peninsulaonlinewebservices/NewRegistrationRequestService.svc", "BasicHttpBinding_INewRegistrationRequestService")]
        ...
        [TestCase("BusinessSafe.Messages.Emails", "businesssafe.messagehandlers.emails@pbsservicebus1")]
        [TestCase("BusinessSafe.Messages", "businesssafe.messagehandlers@pbsservicebus1")]
        [TestCase("Peninsula.Online.Messages", "peninsula.online.messagehandlers@pbsservicebus1")]
        ...
        public void Then_Elmah_settings_are_correct_values()
        {
            ...
            // Then
            Assert.That(securityElement.Attribute("allowRemoteAccess").Value, Is.EqualTo("0"));
        ...
        [TestCase("DBSubscriptionStorageConfig", "connection.connection_string", @"Initial Catalog=NServiceBus;Data Source=pbsprod2sql\prod2;UID=intranetadmin;PWD=intadpas;Connect Timeout=20;")]
        ...
        {
            string fileName = "Web.LIVE.Transformed.config";
            ...
            transformedFilePath = string.IsNullOrEmpty(BuildDirectoryLocations.GetBuildDirectoryLocation(System.Environment.MachineName)) ?
                @"C:\BusinessSafe\Artifacts\BusinessSafe.Website\Configs\Web.LIVE.Transformed.config"
