...
namespace BusinessSafe.Application.IntegrationTests.Config.Tests.BusinessSafe.Checklists
{
    ...
    public class LIVETests : BaseConfigTests
    {
        ...
        private XDocument GetTarget()
        {
            ...
            {
                case "pbs43758":
                    transformedFilePath = @"D:\Code\BusinessSafe\BusinessSafe.Checklists\Web.LIVE.Transformed.config";
                    break;
                default:
                    transformedFilePath = @"C:\BusinessSafe\Artifacts\BusinessSafe.Checklists\Configs\Web.LIVE.Transformed.config";
                    break;
            }
