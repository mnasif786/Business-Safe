...
namespace BusinessSafe.Application.IntegrationTests.Config.Tests.BusinessSafe.MessageHandlers.Emails
{
    ...
    public class UATTests : BaseConfigTests
    {
        ...
        [TestCase("SendExternalEmail", "false")]
        ...
        [TestCase("BusinessSafe.Messages.Events.EmployeeChecklistEmailGenerated, BusinessSafe.Messages", "businesssafe.messagehandlers@UATBSO1")]
        [TestCase("BusinessSafe.Messages.Events.EmployeeChecklistCompleted, BusinessSafe.Messages", "businesssafe.messagehandlers@UATBSO1")]
        [TestCase("BusinessSafe.Messages.Events.TaskAssigned, BusinessSafe.Messages", "businesssafe.messagehandlers.emails@UATBSO1")]
        [TestCase("BusinessSafe.Messages.Events.ReviewAssigned, BusinessSafe.Messages", "businesssafe.messagehandlers.emails@UATBSO1")]
        ...
        [TestCase("TimeoutPersisterConfig", "connection.connection_string", @"Initial Catalog=NServiceBus;Data Source=UATSQL2\uat;UID=intranetadmin;PWD=intadpas;Connect Timeout=20;")]
        [TestCase("NHibernateSagaPersisterConfig", "connection.connection_string", @"Initial Catalog=NServiceBus;Data Source=UATSQL2\uat;UID=intranetadmin;PWD=intadpas;Connect Timeout=20;")]
        ...
        private XDocument GetTarget()
        {
            ...
            {
                case "pbs43758":
                    transformedFilePath = @"D:\Code\BusinessSafe\BusinessSafe.MessageHandlers.Emails\App.UAT.Transformed.config";
                    break;
                default:
                    transformedFilePath = @"C:\BusinessSafe\Artifacts\BusinessSafe.MessageHandlers.Emails\Configs\App.UAT.Transformed.config";
                    break;
            }
