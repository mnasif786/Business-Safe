...
namespace BusinessSafe.Application.IntegrationTests.Config.Tests.BusinessSafe.MessageHandlers
{
    ...
    public class UATTests : BaseConfigTests
    {
        ...
        private XDocument GetTarget()
        {
            ...
            {
                case "pbs43758":
                    transformedFilePath = @"D:\Code\BusinessSafe\BusinessSafe.MessageHandlers\App.UAT.Transformed.config";
                    break;
                default:
                    transformedFilePath = @"C:\BusinessSafe\Artifacts\BusinessSafe.MessageHandlers\Configs\App.UAT.Transformed.config";
                    break;
            }
