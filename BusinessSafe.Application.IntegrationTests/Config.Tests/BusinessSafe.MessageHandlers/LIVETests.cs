...
namespace BusinessSafe.Application.IntegrationTests.Config.Tests.BusinessSafe.MessageHandlers
{
    ...
    public class LIVETests : BaseConfigTests
    {
        ...
        private XDocument GetTarget()
        {
            ...
            {
                case "pbs43758":
                    transformedFilePath = @"D:\Code\BusinessSafe\BusinessSafe.MessageHandlers\App.LIVE.Transformed.config";
                    break;
                default:
                    transformedFilePath = @"C:\BusinessSafe\Artifacts\BusinessSafe.MessageHandlers\Configs\App.LIVE.Transformed.config";
                    break;
            }
