...
namespace BusinessSafe.MessageHandlers.Emails.EmailPusherService {
    ...
    public interface IEmailPusherService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IEmailPusherService/AddNewMessageGetAddNewMessageResponse", ReplyAction="http://tempuri.org/IEmailPusherService/AddNewMessageGetAddNewMessageResponseRespo" +
            "nse")]
        BusinessSafe.MessageHandlers.Emails.EmailPusherService.AddMessageResponse AddNewMessageGetAddNewMessageResponse(string[] recipients, string[] ccrecipients, string[] attachments, string subject, string body, string sender);
        ...
        BusinessSafe.MessageHandlers.Emails.EmailPusherService.AddMessageResponse AddNewMessageWithAttachmentNameGetAddNewMessageResponse(string[] recipients, string[] ccrecipients, BusinessSafe.MessageHandlers.Emails.EmailPusherService.AttachmentType[] attachments, string subject, string body, string sender);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IEmailPusherServiceChannel : BusinessSafe.MessageHandlers.Emails.EmailPusherService.IEmailPusherService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class EmailPusherServiceClient : System.ServiceModel.ClientBase<BusinessSafe.MessageHandlers.Emails.EmailPusherService.IEmailPusherService>, BusinessSafe.MessageHandlers.Emails.EmailPusherService.IEmailPusherService {
        ...
        public BusinessSafe.MessageHandlers.Emails.EmailPusherService.AddMessageResponse AddNewMessageGetAddNewMessageResponse(string[] recipients, string[] ccrecipients, string[] attachments, string subject, string body, string sender) {
            return base.Channel.AddNewMessageGetAddNewMessageResponse(recipients, ccrecipients, attachments, subject, body, sender);
        }
        
        public BusinessSafe.MessageHandlers.Emails.EmailPusherService.AddMessageResponse AddNewMessageWithAttachmentNameGetAddNewMessageResponse(string[] recipients, string[] ccrecipients, BusinessSafe.MessageHandlers.Emails.EmailPusherService.AttachmentType[] attachments, string subject, string body, string sender) {
