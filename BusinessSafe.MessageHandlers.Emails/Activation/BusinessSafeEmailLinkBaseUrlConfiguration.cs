...
{
    public class BusinessSafeEmailLinkBaseUrlConfiguration : IBusinessSafeEmailLinkBaseUrlConfiguration
    {
        public readonly IDictionary<string, string> EmailLinkBaseConfigurations;

        public BusinessSafeEmailLinkBaseUrlConfiguration()
        { }

        public BusinessSafeEmailLinkBaseUrlConfiguration(IDictionary<string, string> emailLinkBaseConfigurations)
        {
