...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_CATALOG = 'BusinessSafe' AND TABLE_NAME = 'Timescale' AND COLUMN_NAME = 'CreatedBy')
BEGIN
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_CATALOG = 'BusinessSafe' AND TABLE_NAME = 'Timescale' AND COLUMN_NAME = 'CreatedOn')
BEGIN
	ALTER TABLE [Timescale]
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_CATALOG = 'BusinessSafe' AND TABLE_NAME = 'Timescale' AND COLUMN_NAME = 'LastModifiedBy')
BEGIN
	ALTER TABLE [Timescale]
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_CATALOG = 'BusinessSafe' AND TABLE_NAME = 'Timescale' AND COLUMN_NAME = 'LastModifiedOn')
BEGIN
	ALTER TABLE [Timescale]
...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_CATALOG = 'BusinessSafe' AND TABLE_NAME = 'Timescale' AND COLUMN_NAME = 'Deleted')
BEGIN
	ALTER TABLE [Timescale]
